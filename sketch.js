...
class Pelota {
    ...
    update() {
        ...
        if (this.x > width - this.diameter / 2 || this.x < this.diameter / 2) {
            sonidoGol.play();
            if (this.x < width / 2) {
                puntosComputadora++;// si la pelota golpea el lado derecho, suma un punto a la computadora
                } else {
                puntosJugador++;// si la pelota golpea el lado izquierdo, suma un punto al jugador
            }
...
function narrarPuntos(){
    // Narra los puntos utilizando la aPI de speechapi
